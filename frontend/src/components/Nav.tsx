...
export function Nav({ repositoriesCount, startsCount }: Props) {
  const [tab] = useQueryParam('tab')
  const navClassNames =
    'py-[8px] px-[16px] text-sm leading-[30px] text-center whitespace-nowrap border-b-2 border-transparent hover:border-[#afb8c133] cursor-pointer transition-all'
          ...
          <div className="col-span-3 ml-3">
            <div className="flex px-4 ml-[1px]">
              <Link to="?tab=overview">
                <div
                  className={clsx(
                    (tab === 'overview' || !tab) && activeNavClassNames,
                    navClassNames
                  )}>
                  <svg
                    aria-hidden="true"
                    ...
                    className="mr-2 inline-block overflow-visible align-text-bottom fill-[#6e7781]">
                    <path
                      fill-rule="evenodd"
              ...
              <Link to="?tab=repositories">
                <div
                  className={clsx(
                    tab === 'repositories' && activeNavClassNames,
                    navClassNames
                  )}>
                  <svg
                    aria-hidden="true"
                  ...
                  Repositories
                  <span className="ml-2 text-[#24292f] bg-[#afb8c133] inline-block py-[2px] px-[6px] text-xs font-medium leading--[18px] text-center rounded-full">
                    {repositoriesCount}
                  </span>
                </div>
              </Link>
              <Link to="?tab=projects">
                <div
                  className={clsx(
                    tab === 'projects' && activeNavClassNames,
                    navClassNames
                  )}>
                  <svg
                    aria-hidden="true"
              ...
              <Link to="?tab=packages">
                <div
                  className={clsx(
                    tab === 'packages' && activeNavClassNames,
                    navClassNames
                  )}>
                  <svg
                    aria-hidden="true"
