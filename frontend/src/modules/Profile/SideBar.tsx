...
export function SideBar({ profile }: Props) {
  return (
    <div>
      ...
      <div className="mb-4">
        <div className="w-full relative text-sm py-[5px] px-[16px] text-center font-medium whitespace-nowrap cursor-pointer align-middle select-none rounded-md border border-[#cdd9e51a] text-[#adbac7] bg-[#373e47] ">
          Edit profile
        </div>
      </div>
      ...
      <div className="mb-4">
        <a className="dark:text-github-dark-link hover:text-blue">
          ...
          <span className="font-semibold text-[#adbac7]">
            {profile.followers}
          </span>{' '}
          followers
        </a>
      ...
      <div className="mb-4 pb-4 border-b border-[#373e47]">
