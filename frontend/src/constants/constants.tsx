...
export const footerOptions = [
  ...
  { label: 'Docs', url: 'https://docs.github.com/es' },
  {
    label: 'Contact GitHub',
    url: 'https://support.github.com/?tags=dotcom-footer'
  },
  { label: 'Pricing', url: 'https://github.com/pricing' },
  { label: 'API', url: 'https://docs.github.com/' },
  { label: 'Training', url: 'https://services.github.com/' },
  { label: 'Blog', url: 'https://github.blog/' },
  { label: 'About', url: 'https://github.com/about' }
]
